        ...
        <div className="relative w-[90vw] max-w-[90em]   mx-auto px-4 sm:px-6">
          ...
          <div className="pt-12 md:pt-20 flex flex-row justify-center">
            ...
            <div className='h-[30em] w-[90vw] max-w-[74em] ml-[-1em]  border-t nonMobile rounded-[1.5em] border-b nonMobile  absolute mt-[-1em]'>
              <div className='flex flex-wrap w-[90vw] max-w-[90em]  nonMobile ml-[2em] mt-[-2em] flex-row  '><div className='w-[2.5em] nonMobile border-[#CFCFCF]  h-[2.5em] mt-[4em] mr-[.5em] nonMobile border rounded-[.5em]'><h1 className='text-[#FFFFFF] text-[12px] z-10 font-bold text-center mt-[.9em]'>01</h1></div> <div className='w-[10em] border-[#CFCFCF]  h-[2.5em] mt-[4em] border rounded-[.5em]'><h1 className='text-[#FFFFFF] text-[12px] z-10 font-bold text-center mt-[.9em]'>Panther Foundation</h1></div></div></div>
