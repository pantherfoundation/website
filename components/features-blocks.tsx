      ...
      <div className="relative h-[185em] max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="py-12 md:py-20">
          ...
          <div className='flex flex-row justify-center'>
            ...
            {/* 1st item */}
            <div className="max-w-lg mr-[1em] mt-[1em] mx-auto text-left pb-12 md:pb-20">

<div className='flex ml-[1.7em] absolute  mt-[2em] mb-[1em]'><Image src={arrow} width={15} height={20} alt={''} className=' mr-[1em] ' /><h1 className="h4 text-black text-[18px] ">02 - Become a part </h1></div>
<p className="text-[12px] absolute  top-[13em]  ml-[1.8em] w-[80vw] text-[#1A1A1A]">Get involved in shaping Panther Protocol's future through various social channels.</p>
</div>
            ...
            <div className="relative flex   flex-col  items-center p-6 bg-white h-[19em] mt-[9em] border-t rounded-[1.5em] border-b border-[#CFCFCF] ">
              <Image src={ribm} width={250} height={300} alt={''} className='absolute  mt-[-6em]' />

              <p className="text-xl    absolute font-bold text-left  w-[80vw] ml-[1em]  mb-1 mt-[8em]">Participate</p>
              <p className="text-gray-600 text-xs  absolute top-[18em] w-[80vw] ml-[1.5em]  text-left">You can shape the future of Panther Protocol by getting involved in governance, and joining the community on the different social channels.</p>
            </div>
        ...
        <div className="relative h-[55em] mt-[45em] w-[90vw] max-w-[90em] mx-auto px-4 sm:px-6">
