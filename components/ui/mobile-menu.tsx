      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="/" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Developers</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Contact Form</Link>
            </li>
